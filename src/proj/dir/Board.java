...
public class Board {
    ...
    //endregion
    //region checkComputerWin
    public boolean checkComputerWin() {
        return (checkComputerWinByColumns() || checkComputerWinByDiagonals() || checkComputerWinByRows());
    }

    //endregion
    //region checkComputerEquality
    private boolean checkEquality(char ch1, char ch2, char ch3) {
        return (ch1 == ch2) && (ch2 == ch3)  && (ch3 == '0');
    }

    //endregion
    //region checkComputerWinByRows
    private boolean checkComputerWinByRows() {
        for (int i = 0; i < height; i++) {
    ...
    //endregion
    //region checkComputerWinByColumns
    private boolean checkComputerWinByColumns() {
    ...
    //endregion
    //region checkComputerWinByDiagonals
    private boolean checkComputerWinByDiagonals() {
